...
export class UserWiseReportComponent {
  ...
  ngOnInit(): void {
    ...
    this.getUserWiseTask();
    this.getUserWiseTaskCountReport();
  ...
  getUserWiseTaskCountReport() {
    ...
    this.KemarService.get<any>(
      null,
      ServiceUrl.GetUserWiseTaskDataCountReport,
      query
    ).subscribe(
      (response) => {
  ...
  DownloadCountReport() {
    ...
    this.KemarService.get<any>(
      null,
      ServiceUrl.GetUserWiseTaskCountReportToDownload,
      query
    ).subscribe(
      (response) => {
  ...
  DownloadUserWiseTaskReport() {
    ...
    this.KemarService.get<any>(
      null,
      ServiceUrl.GetUserWiseReportToDownload,
      query
    ).subscribe(
      (response) => {
        let dataForExcel: unknown[][] = [];
