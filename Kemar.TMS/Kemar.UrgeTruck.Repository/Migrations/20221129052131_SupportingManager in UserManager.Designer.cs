...
namespace Kemar.TMS.Repository.Migrations
{
    ...
    [Migration("20221129052131_SupportingManager in UserManager")]
    partial class SupportingManagerinUserManager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kemar.TMS.Domain.DTOs.DashboardDto", b =>
                {
                    ...
                    b.ToTable("DashboardDto", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Kemar.TMS.Domain.DTOs.DepartmentTaskStatusDto", b =>
                {
                    ...
                    b.ToTable("DepartmentStatus", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Kemar.TMS.Domain.DTOs.DepartmentTaskStatusForPieChartDto", b =>
                {
                    b.Property<int>("NewTask")
                        .HasColumnType("int");
                    ...
                    b.ToTable("DashboardPieChartData", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Kemar.TMS.Domain.DTOs.ProjectWiseTaskCountReport", b =>
                {
                    ...
                    b.ToTable("ProjectTaskCountData", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Kemar.TMS.Domain.DTOs.UserWiseTaskDataCountReport", b =>
                {
                    b.Property<int>("Closed")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserWiseTaskDataCount", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Kemar.UrgeTruck.Repository.Entities.UserManager", b =>
                {
                    ...
                    b.Property<int?>("SupportingManager")
                        .HasColumnType("int");
